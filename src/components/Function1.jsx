      ...
      <div className="row justify-content-start">
        <div className="col-12 col-md-8 col-lg-6 ">
          ...
          <form  className="mt-4" onSubmit={handleSubmit}>
            <div className="mb-3">
              <label>X:</label>
              <input type="number" className="form-control" name="x" placeholder="0" value={formData.x} onChange={handleChange} />
              {errors.x && <span style={{ color: 'red' }}>{errors.x}</span>}
            </div>
            <div className="mb-3">
              <label>Y:</label>
              <input type="number" className="form-control" name="y" placeholder="0" value={formData.y} onChange={handleChange} />
              {errors.y && <span style={{ color: 'red' }}>{errors.y}</span>}
            </div>
            <div className="mb-3">
              <label>C:</label>
              <input type="number" className="form-control" name="c" placeholder="0" value={formData.c} onChange={handleChange} />
        ...
        <div>
          <label>Daily Overnight Funding Buy:</label> 
            <input
              type="number"
      ...
      {result !== null && resultShekel !== null && tax !== null && (
        <>
          <div>
            ...
            <h3>P: {result}</h3>
            <h2>in Shekel: </h2>
            <h3>P: {resultShekel}</h3>
            <h1>before Tax: </h1>
            <h2>in Dollar:</h2>
            <h3>P: {resultBeforeTax}</h3>
            <h2>in Shekel: </h2>
            <h3>P: {resultBeforeTaxShekel}</h3>
          </div>
        </>
      )}
    </div>
